...
import static skinsrestorer.libs.com.google.gson.internal.$Gson$Preconditions.checkArgument;
import static skinsrestorer.libs.com.google.gson.internal.$Gson$Preconditions.checkNotNull;
...
public final class $Gson$Types {
    ...
    /**
     * Returns a type that represents an unknown supertype of {@code bound}. For example, if {@code bound} is {@code String.class}, this returns {@code ?
     * super String}.
     */
    ...
    /**
     * Returns a type that is functionally equal but not necessarily equal according to {@link Object#equals(Object) Object.equals()}. The returned type is {@link java.io.Serializable}.
     */
    ...
    /**
     * Returns the generic supertype for {@code supertype}. For example, given a class {@code IntegerSet}, the result for when supertype is {@code Set.class} is {@code Set<Integer>} and the result when the supertype is {@code Collection.class} is {@code Collection<Integer>}.
     */
    ...
    public static Type[] getMapKeyAndValueTypes(Type context, Class<?> contextRawType) {
        /*
         * Work around a problem with the declaration of java.util.Properties. That class should extend Hashtable<String, String>, but it's declared to extend Hashtable<Object, Object>.
         */
