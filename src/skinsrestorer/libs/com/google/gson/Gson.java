...
import skinsrestorer.libs.com.google.gson.internal.ConstructorConstructor;
import skinsrestorer.libs.com.google.gson.internal.Excluder;
import skinsrestorer.libs.com.google.gson.internal.Primitives;
import skinsrestorer.libs.com.google.gson.internal.Streams;
import skinsrestorer.libs.com.google.gson.internal.bind.ArrayTypeAdapter;
import skinsrestorer.libs.com.google.gson.internal.bind.CollectionTypeAdapterFactory;
import skinsrestorer.libs.com.google.gson.internal.bind.DateTypeAdapter;
import skinsrestorer.libs.com.google.gson.internal.bind.JsonAdapterAnnotationTypeAdapterFactory;
import skinsrestorer.libs.com.google.gson.internal.bind.JsonTreeReader;
import skinsrestorer.libs.com.google.gson.internal.bind.JsonTreeWriter;
import skinsrestorer.libs.com.google.gson.internal.bind.MapTypeAdapterFactory;
import skinsrestorer.libs.com.google.gson.internal.bind.ObjectTypeAdapter;
import skinsrestorer.libs.com.google.gson.internal.bind.ReflectiveTypeAdapterFactory;
import skinsrestorer.libs.com.google.gson.internal.bind.SqlDateTypeAdapter;
import skinsrestorer.libs.com.google.gson.internal.bind.TimeTypeAdapter;
import skinsrestorer.libs.com.google.gson.internal.bind.TypeAdapters;
...
import skinsrestorer.libs.com.google.gson.stream.MalformedJsonException;
 ...
 * </p>
 *
 * @see skinsrestorer.libs.com.google.gson.reflect.TypeToken
 *
...
public final class Gson {
     ...
     * <li>By default, Gson ignores the {@link skinsrestorer.libs.com.google.gson.annotations.Expose} annotation. You can enable Gson to serialize/deserialize only those fields marked with this annotation through {@link GsonBuilder#excludeFieldsWithoutExposeAnnotation()}.</li>
     * <li>By default, Gson ignores the {@link skinsrestorer.libs.com.google.gson.annotations.Since} annotation. You can enable Gson to use this annotation through {@link GsonBuilder#setVersion(double)}.</li>
     * <li>The default field naming policy for the output Json is same as in Java. So, a Java class field <code>versionNumber</code> will be output as <code>&quot;versionNumber&quot;</code> in Json. The same rules are applied for mapping incoming Json to the Java classes. You can change this policy through {@link GsonBuilder#setFieldNamingPolicy(FieldNamingPolicy)}.</li>
     ...
     * <p>
     * Let's say we want to write a type adapter that counts the number of objects being read from or written to JSON. We can achieve this by writing a type adapter factory that uses the <code>getDelegateAdapter</code> method:
     *
     * <pre>
     * {
     * 	&#064;code
     ...
     *
     * @param skipPast
     * The type adapter factory that needs to be skipped while searching for a matching type adapter. In most cases, you should just pass <i>this</i> (the type adapter factory from where {@link #getDelegateAdapter} method is being invoked).
     * @param type
     ...
     * should not be of a generic type. If the object is of generic type, use {@link #toJsonTree(Object, Type)} instead.
     *
     * @param src
     ...
     * @param typeOfSrc
     * The specific genericized type of src. You can obtain this type by using the {@link skinsrestorer.libs.com.google.gson.reflect.TypeToken} class. For example, to get the type for {@code Collection<Foo>}, you should use:
     *
     * <pre>
     ...
     * If the object is of generic type, use {@link #toJson(Object, Type)} instead. If you want to write out the object to a {@link Writer}, use {@link #toJson(Object, Appendable)} instead.
     *
     * @param src
     * the object for which Json representation is to be created setting for Gson
     * @return Json representation of {@code src}.
    ...
    /**
     * This method serializes the specified object into its equivalent Json representation. This method should be used when the specified object is not a generic type. This method uses {@link Class#getClass()} to get the type for the specified object, but the {@code getClass()} loses the generic type information because of the Type Erasure feature of Java. Note that this method works fine if the any of the object fields are of generic type, just the object itself should not be of a generic type.
     * If the object is of generic type, use {@link #toJson(Object, Type, Appendable)} instead.
     *
     * @param src
     * the object for which Json representation is to be created setting for Gson
     * @param writer
     ...
     * generic type. For the cases when the object is of generic type, invoke {@link #fromJson(JsonElement, Type)}.
     *
     * @param <T>
     * the type of the desired object
     * @param json
