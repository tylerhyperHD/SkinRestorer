 ...
 * </pre>
 *
 * Since User class specified UserJsonAdapter.class in &#64JsonAdapter annotation, it will automatically be invoked to serialize/deserialize User instances. <br>
 *
 * <p>
 ...
 * </pre>
 *
 * It's possible to specify different type adapters on a field, that field's type, and in the {@link skinsrestorer.libs.com.google.gson.GsonBuilder}. Field annotations take precedence over {@code GsonBuilder}-registered type adapters, which in turn take precedence over annotated types.
 *
 * <p>
 * The class referenced by this annotation must be either a {@link TypeAdapter} or a {@link TypeAdapterFactory}. Using the factory interface makes it possible to delegate to the enclosing {@code Gson} instance.
 *
 * @since 2.3
 *
