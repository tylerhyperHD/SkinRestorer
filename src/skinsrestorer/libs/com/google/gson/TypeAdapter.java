 ...
 * to {@code beginArray()}, convert all elements, and finish with a call to {@code endArray()}. For objects, they should start with {@code beginObject()}, convert the object, and finish with {@code endObject()}. Failing to convert a value or converting too many values may cause the application to crash.
 *
 * <p>
...
public abstract class TypeAdapter<T> {
    ...
    /**
     * Converts {@code value} to a JSON document and writes it to {@code out}. Unlike Gson's similar {@link Gson#toJson(JsonElement, Appendable) toJson} method, this write is strict. Create a {@link JsonWriter#setLenient(boolean) lenient} {@code JsonWriter} and call {@link #write(skinsrestorer.libs.com.google.gson.stream.JsonWriter, Object)} for lenient writing.
     *
     * @param value
    ...
    /**
     * Converts {@code value} to a JSON document. Unlike Gson's similar {@link Gson#toJson(Object) toJson} method, this write is strict. Create a {@link JsonWriter#setLenient(boolean) lenient} {@code JsonWriter} and call {@link #write(skinsrestorer.libs.com.google.gson.stream.JsonWriter, Object)} for lenient writing.
     *
     * @param value
     * the Java object to convert. May be null.
     * @since 2.2
